...
export const TEST_GROUPS: TestGroup[] = [
    ...
    },
    {
        ...
        tests: [
            ...
            {
                id: 'regression_vscode',
                description: 'VS Code regressions: status bar, file decorations, git index statuses, DU/UD/AU/UA pick flows, merge logic',
                notebooks: ['02_base.ipynb', '02_current.ipynb', '02_incoming.ipynb'],
                testModule: './vscodeRegression.test.js',
                requiresVSCode: true,
            },
        ],
    },
