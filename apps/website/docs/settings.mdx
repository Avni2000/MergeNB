...
title: Settings
sidebar_position: 91
description: Every configuration knob the extension exposes.
---
...
The JSON config mirrors the nested keys:
...
Unknown keys are ignored. Partial files are fine: anything missing falls back to the built-in default for that scope.
