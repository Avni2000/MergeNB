...
| Setting | Default | Effect |
|---|---|---|
| `mergeNB.security.trustContent` | `true` | Renders notebook-authored content (markdown HTML, rich cell outputs) as trusted, but only inside a workspace you've already granted [Workspace Trust](https://code.visualstudio.com/docs/editor/workspace-trust) to. |
