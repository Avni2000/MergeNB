...
\draw[curBdr!90!black, line width=0.6pt] (4.2, 0.2) -- (5.2, 0.2);
\draw[errRed, thick, fill=errRed!10] (5.2, 0.05) rectangle (5.6, 0.35);
...
% Conflicted Text Label
\node[font=\sffamily\small, text=errRed] at (6.1, -1.2) {Conflicted};
...
\draw[->, black!80, line width=0.7pt] (8.4, 6.0) to[out=0, in=180] (9.8, 2.4);
\draw[->, black!80, line width=0.7pt] (8.4, 4.0) to[out=0, in=180] (9.8, 2.15);
\draw[->, black!80, line width=0.7pt] (8.4, 2.0) to[out=0, in=180] (9.8, 1.9);
\draw[->, black!80, line width=0.7pt] (8.4, 0.0) to[out=0, in=180] (9.8, 1.6);
